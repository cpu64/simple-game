...
public class HeavyBullet : Bullet, ICollidable, IGravityAffected, IMoving, ILifespan, IBinarySerializable
{
    ...
    {
        return $"HeavyBullet {Id}: Position={Position}, FiredBy={FiredBy}, " + $"Velocity={Velocity}, TicksLeft={TicksLeft}";
    }
